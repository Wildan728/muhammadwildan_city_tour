        ...
        body: SingleChildScrollView(
          ...
          child: Column(
            children: [
              ...
              const Text("Explore, Enjoy, Experience",
                style: TextStyle(
                  fontSize: 20,
